...
positions_times = [(MycobotPose(frame="gripper", x=0.15, y=0.0, z=0.2, rx=180.0, ry=20.0, rz=0.0), 5.0),
                    (MycobotPose(frame="gripper", x=0.15, y=0.0, z=0.001, rx=180.0, ry=20.0, rz=0.0), 5.0),
                    (MycobotPose(frame="gripper", x=0.15, y=0.0, z=-0.03, rx=180.0, ry=20.0, rz=0.0), 7.0),
