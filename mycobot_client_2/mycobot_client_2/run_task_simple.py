...
positions_times = [(MycobotPose(frame="gripper", x=0.2, y=0.0, z=0.2, rx=180.0, ry=25.0, rz=0.0), 2.0, False),
                    ...
                    (MycobotPose(frame="gripper", x=0.17, y=-0.15, z=0.3, rx=180.0, ry=10.0, rz=0.0), 2.0, True),
                    (MycobotPose(frame="gripper", x=0.17, y=-0.15, z=0.3, rx=180.0, ry=10.0, rz=0.0), 5.0, False)]
